...
export const instagramTestimonials: InstagramTestimonial[] = [
  {
    id: "authenticity",
    text_en:
      "Thank you so much — everything you sell is original, that means the world to me. Inshallah I'll always be a customer ♥",
    text_ar:
  ...
  },
  {
    ...
    text_en:
      "I really loved the sunscreen — light texture, absorbs into the skin so fast. The moisturizer arrived yesterday too, lightweight just the way I like it.",
    text_ar:
