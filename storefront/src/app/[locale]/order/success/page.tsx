      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
        ...
        <div className="mt-8 rounded-2xl bg-surface p-6 shadow-soft space-y-4">
          <div className="flex items-center gap-3 text-start">
            ...
            <p className="font-medium text-text-primary">{t("confirmed")}</p>
          </div>
          <div className="flex items-center gap-3 text-start">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-secondary/10 shrink-0">
              <Clock className="h-5 w-5 text-secondary" />
            </div>
            <p className="font-medium text-text-primary">{t("preparing")}</p>
          </div>
          <div className="flex items-center gap-3 text-start">
            ...
            <div>
              <p className="font-medium text-text-primary">{t("delivery")}</p>
              <p className="text-xs text-text-muted">{t("deliveryTime")}</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 space-y-3">
          <Link href="/shop">
            <Button size="lg" className="w-full">{t("continueShopping")}</Button>
          </Link>
          <Link href="/" className="block">
            <Button variant="ghost" className="w-full">{t("backHome")}</Button>
          </Link>
        </div>
      </motion.div>
    </div>
